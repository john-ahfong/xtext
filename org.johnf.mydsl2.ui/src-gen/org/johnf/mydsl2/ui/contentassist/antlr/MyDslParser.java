 ...
 * generated by Xtext
 */
package org.johnf.mydsl2.ui.contentassist.antlr;
...
public class MyDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.johnf.mydsl2.ui.contentassist.antlr.internal.InternalMyDslParser createParser() {
		org.johnf.mydsl2.ui.contentassist.antlr.internal.InternalMyDslParser result = new org.johnf.mydsl2.ui.contentassist.antlr.internal.InternalMyDslParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getPartitionAccess().getAlternatives(), "rule__Partition__Alternatives");
					put(grammarAccess.getCrossReferenceTargetAccess().getAlternatives(), "rule__CrossReferenceTarget__Alternatives");
					...
					put(grammarAccess.getDefinitionImportAccess().getGroup(), "rule__DefinitionImport__Group__0");
					...
					put(grammarAccess.getModelAccess().getSystemsAssignment_5(), "rule__Model__SystemsAssignment_5");
					put(grammarAccess.getSystemAccess().getNameAssignment_1(), "rule__System__NameAssignment_1");
					put(grammarAccess.getSystemAccess().getDescriptionAssignment_3_1(), "rule__System__DescriptionAssignment_3_1");
					put(grammarAccess.getSystemAccess().getImportsAssignment_4(), "rule__System__ImportsAssignment_4");
					put(grammarAccess.getSystemAccess().getDataTypesAssignment_5(), "rule__System__DataTypesAssignment_5");
					put(grammarAccess.getDefinitionImportAccess().getDefinitionAssignment_1(), "rule__DefinitionImport__DefinitionAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.johnf.mydsl2.ui.contentassist.antlr.internal.InternalMyDslParser typedParser = (org.johnf.mydsl2.ui.contentassist.antlr.internal.InternalMyDslParser) parser;
