...
public class MyDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.johnf.mydsl2.MyDslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.johnf.org/MyDsl")) {
		EPackage.Registry.INSTANCE.put("http://www.johnf.org/MyDsl", org.johnf.mydsl2.myDsl.MyDslPackage.eINSTANCE);
	}
